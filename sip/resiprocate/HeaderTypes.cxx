...
Header<Headers::Content_Disposition> Vocal2::h_Content_Disposition;
Header<Headers::Content_Encoding> Vocal2::h_Content_Encoding;
Header<Headers::MIME_Version> Vocal2::h_MIME_Version;
Header<Headers::Priority> Vocal2::h_Priority;
MultiHeader<Headers::Accept_Encoding> Vocal2::h_Accept_Encodings;
MultiHeader<Headers::Accept_Language> Vocal2::h_Accept_Languages;
MultiHeader<Headers::Allow> Vocal2::h_Allows;
MultiHeader<Headers::Content_Language> Vocal2::h_Content_Languages;
MultiHeader<Headers::Proxy_Require> Vocal2::h_Proxy_Requires;
...
Header<Headers::Content_Type> Vocal2::h_Content_Type;
MultiHeader<Headers::Alert_Info> Vocal2::h_Alert_Infos;
MultiHeader<Headers::Error_Info> Vocal2::h_Error_Infos;
MultiHeader<Headers::Record_Route> Vocal2::h_Record_Routes;
...
Header<Headers::User_Agent> Vocal2::h_User_Agent;
Header<Headers::Content_Length> Vocal2::h_Content_Length;
Header<Headers::Expires> Vocal2::h_Expires;
Header<Headers::Max_Forwards> Vocal2::h_Max_Forwards;
Header<Headers::Min_Expires> Vocal2::h_Min_Expires;
Header<Headers::Retry_After> Vocal2::h_Retry_After;
Header<Headers::Call_ID> Vocal2::h_Call_ID;
Header<Headers::In_Reply_To> Vocal2::h_In_Reply_To;
Header<Headers::Authentication_Info> Vocal2::h_Authentication_Info;
Header<Headers::Authorization> Vocal2::h_Authorization;
Header<Headers::Proxy_Authenticate> Vocal2::h_Proxy_Authenticate;
Header<Headers::Proxy_Authorization> Vocal2::h_Proxy_Authorization;
Header<Headers::WWW_Authenticate> Vocal2::h_WWW_Authenticate;
...
MultiHeader<Headers::Subscription_State> Vocal2::h_Subscription_States;
Vocal2::RequestLineType Vocal2::h_Request_Line;
Vocal2::StatusLineType Vocal2::h_Status_Line;

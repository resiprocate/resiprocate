...
S2C_S2C_TEST_LOCAL_LDFLAGS        = -L. -ls2ctest s2c_native.o -L$(RESIPROCATE_SRCDIR)rutil/obj.$(RESIPROCATE_DEBUG)$(RESIPROCATE_PLATFORM) -lrutil 
...
#    LOCAL ENVIRONMENT
#
S2C_S2C_TEST_BUILD                = libs2ctest.$(ARSUFFIX) test.$(OBJSUFFIX) \
                                    test.d test_s2c test_s2c.$(OBJSUFFIX) \
                                    test_s2c.d
...
test.$(OBJSUFFIX): $(S2C_S2C_TEST_SRCDIR)test.s2c test.d
	$(COMPILE.s2c) $@ $< $(S2C_S2C_TEST_LOCAL_CFLAGS) $(GLOBAL_CFLAGS)

test.d: $(S2C_S2C_TEST_SRCDIR)test.s2c
...
libs2ctest.$(ARSUFFIX): test.$(OBJSUFFIX)

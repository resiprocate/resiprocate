...
/*           Below are the error description from SSL_ERROR_SYSCALL, this is same as strerror() but with more error desription [http://www.cl.cam.ac.uk/cgi-bin/manpage?3+errno]            */

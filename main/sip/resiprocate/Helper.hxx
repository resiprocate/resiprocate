...
class Helper
{
   public:
      ...
      static SipMessage makeInvite(const Url& target,
                                   const Url& from,
                                   const Url& contact);
      ...
      static SipMessage makeResponse(const SipMessage& request, int responseCode, const Url& myContact);

      //to, maxforwards=70, requestLine& cseq method set, cseq sequence is 1
      static SipMessage makeRequest(const Url& target, MethodTypes method); // deprecated
      ...
      static SipMessage makeRequest(const Url& target, 
                                    const Url& from,
                                    const Url& contact,
                                    MethodTypes method);
      ...
      static SipMessage makeRegister(const Url& proxy,
                                     const Url& aor);
      ...
      static void setUri(RequestLine& rLine, const Url& url);
      static void setUri(StatusLine& rLine, const Url& url);

...
class SubscriptionCreator : public BaseCreator 
{
   public:
      ...
      SubscriptionCreator(DialogUsageManager& dum, const NameAddr& target, Identity &identity, const Data& event, int subscriptionTime);
      SubscriptionCreator(DialogUsageManager& dum, const NameAddr& target, Identity &identity, const Data& event, 

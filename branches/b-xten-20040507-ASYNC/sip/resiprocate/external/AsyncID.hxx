...
// taht accept Async ids, another way is to have them passed around by
...
//error code of zero is success...these errors could be standard socket error codes, but a better idea is probably
//to get an informative message from the transport.
class AsyncResult
{
   public:

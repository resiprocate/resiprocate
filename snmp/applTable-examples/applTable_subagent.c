...
{
    printf
        ("usage: applTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
    ...
    while ((ch = getopt(argc, argv, "D:fHLM-:x:")) != EOF)
        ...
        case 'H':
            ...
            init_agent("applTable");    /* register our .conf handlers */
            init_applTable();
            init_snmp("applTable");
     ...
     */
    init_agent("applTable");

    /*
     * init applTable mib code 
     */
    init_applTable();

    /*
     * read applTable.conf files. 
     */
    init_snmp("applTable");
